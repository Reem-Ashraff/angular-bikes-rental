...
const routes: Routes = [
  ...
  { path: "dashboard", component: DashboardComponent,canActivate:[AuthGuard],data:{role:["admin"]}, children: [
    ...
    { path: "deletecategory", component: DeletecategoryComponent ,canActivate:[AuthGuard],data:{role:["admin"]}},
    ...
    { path: "deleteoffer", component: DeleteofferComponent ,canActivate:[AuthGuard],data:{role:["admin"]}},
    { path: "deletelocation", component: DeletelocationComponent ,canActivate:[AuthGuard],data:{role:["admin"]}}
  ] },
